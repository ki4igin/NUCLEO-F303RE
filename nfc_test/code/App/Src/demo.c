...
static uint8_t ndefInit[]     = {0x05, 0x20, 0x06, 0x0F, 0x75, 0x72, 0x6E, 0x3A, 0x6E, 0x66, 0x63, 0x3A, 0x73,
                             0x6E, 0x3A, 0x73, 0x6E, 0x65, 0x70, 0x02, 0x02, 0x07, 0x80, 0x05, 0x01, 0x02};
static uint8_t ndefUriSTcom[] = {0x13, 0x20, 0x00, 0x10, 0x02, 0x00, 0x00, 0x00, 0x19, 0xc1, 0x01, 0x00, 0x00, 0x00, 0x12, 0x55, 0x00,
                                 0x68, 0x74, 0x74, 0x70, 0x3a, 0x2f, 0x2f, 0x77, 0x77, 0x77, 0x2e, 0x73, 0x74, 0x2e, 0x63, 0x6f, 0x6d};
...
static uint8_t ceNFCF_SENSF_RES[] = {0x01, /* SENSF_RES                                */
                                     ...
                                     0x7F,
                                     0x7F,
                                     0x00, /* PAD0, PAD01, MRTIcheck, MRTIupdate, PAD2 */
                                     0x00,
                                     0x00}; /* RD                                       */
...
static void demoNfcv(rfalNfcvListenDevice *nfcvDev)
{
  ...
  {      
    err = rfalNfcvPollerWriteSingleBlock(RFAL_NFCV_REQ_FLAG_DEFAULT, uid, i, &wrData.pdata[4 * i], DEMO_NFCV_BLOCK_LEN);
    platformLog(" Write Block: %s Data: %s\r\n", (err != ERR_NONE) ? "FAIL" : "OK", hex2Str(&wrData.pdata[4 * i], DEMO_NFCV_BLOCK_LEN));
    /* code */
  }
